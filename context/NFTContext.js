...
import marketplace from '../src/nftMarketplace.json';

export const NFTContext = React.createContext();

const fetchContract = (signerOrProvider) => new ethers.Contract(marketplace.address, marketplace.abi, signerOrProvider);
